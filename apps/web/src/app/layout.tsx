...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'TrackerStat.gg — Domina cada partida con datos reales',
    description: 'Plataforma de analítica competitiva para League of Legends, TFT, Valorant y más.',
  ...
  twitter: {
    ...
    description: 'Analítica competitiva para League of Legends, TFT, Valorant y más.',
  },
}
