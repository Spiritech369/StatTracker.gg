...
export const siteConfig: SiteConfig = {
  ...
  description: "Track your gaming performance with professional-grade statistics, champion analytics, and real-time leaderboards. The ultimate tool for competitive gamers.",
  language: "en",
};
...
export const heroConfig: HeroConfig = {
  ...
  subtitle: "Professional-grade analytics for competitive gamers. Track stats, analyze champions, and climb the ranks with data-driven insights.",
...
export const tourScheduleConfig: TourScheduleConfig = {
  ...
  tourDates: [
    { id: 1, date: "2025.01.15", time: "18:00", city: "Seoul", venue: "LOL Park", status: "on-sale", image: "/venue-seoul.jpg" },
    { id: 2, date: "2025.02.22", time: "17:00", city: "Los Angeles", venue: "Riot Games Arena", status: "on-sale", image: "/venue-la.jpg" },
    { id: 3, date: "2025.03.08", time: "19:00", city: "Berlin", venue: "LEC Studio", status: "coming-soon", image: "/venue-berlin.jpg" },
    { id: 4, date: "2025.04.12", time: "16:00", city: "Shanghai", venue: "Mercedes-Benz Arena", status: "coming-soon", image: "/tournament-1.jpg" },
  ],
};
...
export const footerConfig: FooterConfig = {
  ...
  brandName: "StatTracker.gg",
  brandDescription: "The ultimate gaming analytics platform for competitive players. Track your performance, analyze champions, and dominate the leaderboard with professional-grade statistics.",
